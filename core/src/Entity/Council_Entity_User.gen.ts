...
// @ts-ignore: Implicit any on import
import * as Council_Entity_UserBS__Es6Import from './Council_Entity_User.bs';
const Council_Entity_UserBS: any = Council_Entity_UserBS__Es6Import;

import type {t as Council_Entity_User_Id_t} from './Council_Entity_User_Id.gen';

import type {t as Date_t} from '../../src/Date.gen';
